...
export default function KolmaPOSPremium() {
  ...
  // Control exacto de ventas y piezas del turno
  ...
  return (
    <div className="flex h-screen bg-[#F6F6F7] text-[#202223] font-sans overflow-hidden relative">
      ...
      {/* MODAL CORTE DE CAJA (RESUMEN DE TURNO) */}
      {showShiftModal && (
          ...
          <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-8 md:p-10 text-center">
              ...
              <div className="space-y-3">
                <button 
                  onClick={resetShift}
                  className="w-full py-5 bg-orange-600 text-white rounded-2xl font-black text-sm uppercase tracking-[0.2em] hover:bg-orange-700 transition-all shadow-[0_10px_20px_rgba(234,88,12,0.3)] activ 
